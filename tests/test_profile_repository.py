...
class TestProfileRepository:
    ...
    def test_list_profiles(self, repository):
        ...
        profile1 = UIProfile(
            name="Profile 1", created_at=now, modified_at=now, output_format="html"
        )

        profile2 = UIProfile(name="Profile 2", created_at=now, modified_at=now, output_format="pdf")
    ...
    def test_get_profile_count(self, repository):
        ...
        for i in range(3):
            profile = UIProfile(
                name=f"Profile {i + 1}", created_at=now, modified_at=now, output_format="html"
            )
