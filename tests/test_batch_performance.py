...
class TestBatchPerformance:
    ...
    def test_batch_vs_native_performance(self, scanner, test_files_dir, tmp_path):
        ...
        success = task_queue.wait_for_completion(30000)
        ...
        if native_time > 0 and native_success > 0:
            ...
            assert overhead <= 300, f"Overhead {overhead:.1f}% exceeds reasonable limit"
            if overhead > 100:
                print(f"Note: High overhead expected for small files due to thread management")
