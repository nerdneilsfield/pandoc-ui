...
class TestEndToEnd:
    ...
    def test_complete_gui_workflow_mock(self, main_window, sample_markdown_file):
        ...
        handler.ui.inputFileEdit.setText(str(sample_markdown_file))
    ...
    def test_pandoc_detection_workflow(self, mock_service, main_window):
        """Test pandoc detection affects UI state."""
        handler = main_window.ui_handler
        
        # Test with pandoc available
        mock_instance = Mock()
    ...
    def test_error_handling_workflow(self, main_window):
        ...
        handler.ui.inputFileEdit.setText("nonexistent_file.md")
    ...
    def test_conversion_profile_creation(self, main_window, sample_markdown_file):
        ...
        def mock_worker_init(profile, parent=None):
