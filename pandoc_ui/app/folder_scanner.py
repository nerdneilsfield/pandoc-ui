...
class ScanResult:
    ...
    def summary(self) -> str:
        ...
        return (
            f"Found {self.total_count} files, "
...
class FolderScanner:
    ...
    def __init__(self) -> None:
        ...
        self._scan_stats = {"total_scanned": 0, "last_scan_duration": 0.0, "errors_encountered": []}
    ...
    def scan_folder(
        ...
        try:
            ...
            logger.info(
                f"Scan completed: {len(all_files)} total, "
    ...
    def _scan_recursive(
        self, folder_path: Path, ignore_patterns: set[str], max_files: int
    ) -> list[Path]:
    ...
    def get_supported_extensions(self, output_format: OutputFormat | None = None) -> set[str]:
        """
        ...
        if output_format == OutputFormat.PDF:
            ...
            return (
                self.DEFAULT_EXTENSIONS["markdown"]
            ...
            return self.DEFAULT_EXTENSIONS["markdown"] | self.DEFAULT_EXTENSIONS["restructuredtext"]
    ...
    def estimate_batch_size(
        self, folder_path: Path, extensions: set[str] | None = None
    ) -> dict[str, Any]:
        """
