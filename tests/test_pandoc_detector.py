...
class TestPandocDetector:
    ...
    @patch.dict('os.environ', {'PROGRAMFILES': 'C:\\Program Files', 'PROGRAMFILES(X86)': 'C:\\Program Files (x86)', 'USERPROFILE': 'C:\\Users\\test'})
    def test_get_search_paths_windows(self, mock_system):
        ...
        assert any('Program Files' in p and 'Pandoc' in p and 'pandoc.exe' in p for p in path_strings)
        assert any('Program Files (x86)' in p and 'pandoc' in p and 'pandoc.exe' in p for p in path_strings)
